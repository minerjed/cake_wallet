...
. ./config.sh
XCASH_BRANCH=release-v0.18.2.2-android
XCASH_SRC_DIR=${WORKDIR}/xcash

git clone https://github.com/minerjed/xcash-tech-core.git ${XCASH_SRC_DIR} ##   --branch ${XCASH_BRANCH}
cd $XCASH_SRC_DIR
git submodule init
...
DEST_LIB_DIR=${PREFIX}/lib/xcash
DEST_INCLUDE_DIR=${PREFIX}/include/xcash
