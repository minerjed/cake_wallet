...
TYPES=($MONERO_COM $CAKEWALLET $HAVEN $XCASH)
APP_ANDROID_TYPE=$1
...
XCASH_NAME="XCash"
XCASH_VERSION="1.0.0"
XCASH_BUILD_NUMBER=1
XCASH_BUNDLE_ID="com.cakewallet.xcash"
XCASH_PACKAGE="com.cakewallet.xcash"
...
case $APP_ANDROID_TYPE in
	...
	$HAVEN)
		...
		;;
	$XCASH)
		APP_ANDROID_NAME=$XCASH_NAME
		APP_ANDROID_VERSION=$XCASH_VERSION
		APP_ANDROID_BUILD_NUMBER=$XCASH_BUILD_NUMBER
		APP_ANDROID_BUNDLE_ID=$XCASH_BUNDLE_ID
		APP_ANDROID_PACKAGE=$XCASH_PACKAGE
		;;
esac
