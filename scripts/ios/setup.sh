...
CW_XCASH_EXTERNAL_LIB=../../../../../cw_xcash/ios/External/ios/lib
CW_XCASH_EXTERNAL_INCLUDE=../../../../../cw_xcash/ios/External/ios/include
...
ln ./libboost.a ${CW_XCASH_EXTERNAL_LIB}/libboost.a
ln ./libcrypto.a ${CW_XCASH_EXTERNAL_LIB}/libcrypto.a
ln ./libssl.a ${CW_XCASH_EXTERNAL_LIB}/libssl.a
ln ./libsodium.a ${CW_XCASH_EXTERNAL_LIB}/libsodium.a
ln ./libunbound.a ${CW_XCASH_EXTERNAL_LIB}/libunbound.a
cp ./libxcash.a $CW_XCASH_EXTERNAL_LIB
cp ../include/xcash/* $CW_XCASH_EXTERNAL_INCLUDE
