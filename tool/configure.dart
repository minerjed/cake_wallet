...
const xcashOutputPath = 'lib/xcash/xcash.dart';
...
Future<void> main(List<String> args) async {
  ...
  final hasXCash = args.contains('${prefix}xcash');
...
import 'package:hive/hive.dart';
import 'package:cw_core/crypto_currency.dart';""";
  const xcashCWHeaders = """
import 'package:cw_core/get_height_by_date.dart';
import 'package:cw_core/monero_amount_format.dart';
import 'package:cw_core/monero_transaction_priority.dart';
import 'package:cw_xcash/xcash_wallet_service.dart';
...
import 'package:cw_core/account.dart' as monero_account;
import 'package:cw_xcash/api/wallet.dart' as monero_wallet_api;
import 'package:cw_xcash/mnemonics/english.dart';
import 'package:cw_xcash/mnemonics/chinese_simplified.dart';
import 'package:cw_xcash/mnemonics/dutch.dart';
import 'package:cw_xcash/mnemonics/german.dart';
import 'package:cw_xcash/mnemonics/japanese.dart';
import 'package:cw_xcash/mnemonics/russian.dart';
import 'package:cw_xcash/mnemonics/spanish.dart';
import 'package:cw_xcash/mnemonics/portuguese.dart';
import 'package:cw_xcash/mnemonics/french.dart';
import 'package:cw_xcash/mnemonics/italian.dart';
import 'package:cw_xcash/xcash_transaction_creation_credentials.dart';
import 'package:cw_xcash/api/balance_list.dart';
""";
  const xcashCwPart = "part 'cw_xcash.dart';";
  const xcashContent = """
class Account {
  Account({required this.id, required this.label});
  final int id;
...
abstract class XCashAccountList {
  ...
  const xcashEmptyDefinition = 'XCash? xcash;\n';
  const xcashCWDefinition = 'XCash? xcash = CWXCash();\n';

  final output = '$xcashCommonHeaders\n' +
      (hasImplementation ? '$xcashCWHeaders\n' : '\n') +
      (hasImplementation ? '$xcashCwPart\n\n' : '\n') +
      (hasImplementation ? xcashCWDefinition : xcashEmptyDefinition) +
      '\n' +
      xcashContent;
...
Future<void> generateWalletTypes(
  ...
  if (hasXCash) {
    outputContent += '\tWalletType.xcash,\n';
  }
