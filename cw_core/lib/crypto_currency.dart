...
class CryptoCurrency extends EnumerableItem<int> with Serializable<int> implements Currency {
  ...
  static const xcash = CryptoCurrency(title: 'XCASH', fullName: 'XCash', raw: 89, name: 'xcash', iconPath: 'assets/images/xcash_logo.png', decimals: 6);

  static const xxag = CryptoCurrency(title: 'XAG', tag: 'XCASH',  raw: 90, name: 'xag', decimals: 6);
  static const xxau = CryptoCurrency(title: 'XAU', tag: 'XCASH', raw: 91, name: 'xau', decimals: 6);
  static const xxaud = CryptoCurrency(title: 'XAUD', tag: 'XCASH', raw: 92, name: 'xaud', decimals: 6);
  static const xxbtc = CryptoCurrency(title: 'XBTC', tag: 'XCASH', raw: 93, name: 'xbtc', decimals: 6);
  static const xxcad = CryptoCurrency(title: 'XCAD', tag: 'XCASH', raw: 94, name: 'xcad', decimals: 6);
  static const xxchf = CryptoCurrency(title: 'XCHF', tag: 'XCASH', raw: 95, name: 'xchf', decimals: 6);
  static const xxcny = CryptoCurrency(title: 'XCNY', tag: 'XCASH', raw: 96, name: 'xcny', decimals: 6);
  static const xxeur = CryptoCurrency(title: 'XEUR', tag: 'XCASH', raw: 97, name: 'xeur', decimals: 6);
  static const xxgbp = CryptoCurrency(title: 'XGBP', tag: 'XCASH', raw: 98, name: 'xgbp', decimals: 6);
  static const xxjpy = CryptoCurrency(title: 'XJPY', tag: 'XCASH', raw: 99, name: 'xjpy', decimals: 6);
  static const xxnok = CryptoCurrency(title: 'XNOK', tag: 'XCASH', raw: 100, name: 'xnok', decimals: 6);
  static const xxnzd = CryptoCurrency(title: 'XNZD', tag: 'XCASH', raw: 101, name: 'xnzd', decimals: 6);
  static const xxusd = CryptoCurrency(title: 'XUSD', tag: 'XCASH', raw: 102, name: 'xusd', decimals: 6);

  static final Map<int, CryptoCurrency> _rawCurrencyMap =
    [...all, ...havenCurrencies, ...xcashCurrencies].fold<Map<int, CryptoCurrency>>(<int, CryptoCurrency>{}, (acc, item) {
      acc.addAll({item.raw: item});
      return acc;
    });

  static final Map<String, CryptoCurrency> _nameCurrencyMap =
    [...all, ...havenCurrencies, ...xcashCurrencies].fold<Map<String, CryptoCurrency>>(<String, CryptoCurrency>{}, (acc, item) {
